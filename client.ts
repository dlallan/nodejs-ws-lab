...
// if the placeholder was passed, return a random number from 0 to 15 
// unless b is 8,in which casea random number from 8 to 11 in hexadecimal 
// or otherwise a concatenated string:
// 10000000 + -1000 + -4000 + -80000000 + -100000000000, replacing zeroes, 
// ones, and eights with random hex digits
function uuid(
  a?: any           // placeholder     
): string {
  return a
